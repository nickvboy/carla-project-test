...
class CarlaSimulator:
    ...
    def process_image(self, image):
        ...
        if self.trial_run_active or self.trial_countdown or (self.trial_running and time.time() - self.go_text_display_time < 2) or self.results_displayed:
    ...
    def display_trial_run_screen(self):
        ...
        if self.trial_countdown or (self.trial_running and time.time() - self.go_text_display_time < 2):
...
def main():
    # Default settings
    server_ip = 'localhost'  # IP address of the CARLA server
    ...
    throttle_sensitivity = 1.0  # Sensitivity of throttle controls
    steering_sensitivity = 1.0  # Sensitivity of steering controls
